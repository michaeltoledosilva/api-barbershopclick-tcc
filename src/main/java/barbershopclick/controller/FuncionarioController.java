...
import barbershopclick.service.FuncionarioService;
...
public class FuncionarioController {
	...
	@PostMapping("/save")
	public ResponseEntity<Object> save(@RequestBody FuncionarioDto dto) {
		try {
	...
	@PutMapping("/update")
	public ResponseEntity<Object> update(@RequestBody FuncionarioDto dto) {
		try {
