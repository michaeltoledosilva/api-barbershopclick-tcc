...
import barbershopclick.service.AgendaService;
...
public class AgendaController {
	...
	public ResponseEntity<Object> findSchedules(HttpServletRequest req) {
		try {
			return new ResponseEntity<>(this.service.findSchedules(), HttpStatus.OK);
		} catch (Exception e) {
			return new ResponseEntity<>(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	@PostMapping("/save")
	public ResponseEntity<Object> save(@RequestBody AgendaDto dto) {
		try {
